import { Component, OnInit, OnDestroy, Input, Output, EventEmitter, HostBinding, HostListener, ElementRef, ChangeDetectorRef, ChangeDetectionStrategy } from '@angular/core';
...
export class AnimateComponent implements OnInit, OnDestroy {
  ...
  constructor(private elm: ElementRef, private scroll: AnimateService, private cd: ChangeDetectorRef) {}
  ...
  ngOnInit() {
    ...
    this.sub = this.replay$.pipe( 
      ...
      // Marks the change detection for changes
